                     ...
                     while($row=mysqli_fetch_array($query))
                        {
                          ...
                          <tr>
                            ...
                            <td>
                                ...
                                <?php
                            if($row['severity']=="Murder"){
                            echo "<p  class='btn btn-danger'>Murder</p>";   
                            }elseif($row['severity']=="Kidnapping"){
                            echo "<p  class='btn btn-danger'>Kidnapping</p>";
                            }elseif($row['severity']=="Theft"){
                            echo "<p  class='btn btn-danger'>Theft</p>";
                            }elseif($row['severity']=="Missing Person"){
                            echo "<p  class='btn btn-danger'>Missing Person</p>";
                            }elseif($row['severity']=="Domestic Abuse"){
                            echo "<p  class='btn btn-danger'>Domestic Abuse</p>";
                            }elseif($row['severity']=="Petty Crime"){
                            echo "<p  class='btn btn-danger'>Petty Crime</p>";
                            }else{
                            echo "<p  class='btn btn-danger'>Arson</p>";
                            }     
                            ?>  
